...
#define P_FLAG_FORCE_SHINY                          (SYSTEM_FLAGS + 0x22)   // force creation of a shiny mon
...
#define FLAG_SYS_DEXNAV_GET                         (SYSTEM_FLAGS + 0x2F) // dexnav shows in start menu - 0x88F
