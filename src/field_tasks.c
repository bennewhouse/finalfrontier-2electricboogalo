...
static void TryLowerFortreeBridge(s16 x, s16 y)
{
    ...
    if (!(elevation & 1))
    {
        ...
        case METATILE_Fortree_BridgeOverTrees_Raised:
            ...
            break;
        case METATILE_Fortree_BridgeVertical_Raised:
            MapGridSetMetatileIdAt(x, y, METATILE_Fortree_BridgeVertical_Lowered);
            break;
...
static void TryRaiseFortreeBridge(s16 x, s16 y)
{
    ...
    if (!(elevation & 1))
    {
        ...
        case METATILE_Fortree_BridgeOverTrees_Lowered:
            ...
            break;
        case METATILE_Fortree_BridgeVertical_Lowered:
            MapGridSetMetatileIdAt(x, y, METATILE_Fortree_BridgeVertical_Raised);
            break;
        }
    }
}
