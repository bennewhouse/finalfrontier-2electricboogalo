...
#define SCEPTILE_MISC_INFO                                  \
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Torchic, 40, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Torchic,
        .frontAnimId = ANIM_H_STRETCH,
        BACK_PIC(Torchic, 48, 56),
...
#define BLAZIKEN_MISC_INFO                                  \
    ...
    [SPECIES_MUDKIP] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Mudkip, 40, 48),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_Mudkip,
        .frontAnimId = ANIM_CIRCULAR_STRETCH_TWICE,
        BACK_PIC(Mudkip, 56, 56),
        .backPicYOffset = 5,
...
#define SWAMPERT_MISC_INFO                                      \
    ...
    [SPECIES_SWAMPERT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Swampert, 64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Swampert,
        .frontAnimId = ANIM_V_JUMPS_BIG,
        BACK_PIC(Swampert, 64, 56),
        .backPicYOffset = 5,
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Poochyena, 40, 40),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_Poochyena,
        .frontAnimId = ANIM_V_SHAKE,
        BACK_PIC(Poochyena, 56, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(Poochyena),
        ICON(Poochyena, 2),
    ...
    [SPECIES_MIGHTYENA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Mightyena, 64, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_Mightyena,
        .frontAnimId = ANIM_V_SHAKE,
        BACK_PIC(Mightyena, 64, 56),
        .backPicYOffset = 4,
...
#define LINOONE_MISC_INFO                                                       \
    ...
    [SPECIES_ZIGZAGOON] =
    {
        ...
        FRONT_PIC(Zigzagoon, 64, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_Zigzagoon,
        .frontAnimId = ANIM_H_SLIDE,
        BACK_PIC(Zigzagoon, 56, 48),
        .backPicYOffset = 11,
    ...
    [SPECIES_LINOONE] =
    {
        ...
        FRONT_PIC(Linoone, 56, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_Linoone,
        .frontAnimId = ANIM_GROW_VIBRATE,
        BACK_PIC(Linoone, 64, 40),
        .backPicYOffset = 15,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        PALETTES(Linoone),
        ICON(Linoone, 2),
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Wurmple, 32, 40),
        .frontPicYOffset = 14,
        .frontAnimFrames = sAnims_Wurmple,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Wurmple, 56, 48),
        .backPicYOffset = 11,
    ...
    [SPECIES_SILCOON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Silcoon, 56, 40),
        .frontPicYOffset = 17,
        .frontAnimFrames = sAnims_Silcoon,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Silcoon, 64, 24),
        .backPicYOffset = 21,
        .backAnimId = BACK_ANIM_H_SHAKE,
        PALETTES(Silcoon),
        ICON(Silcoon, 2),
    ...
    [SPECIES_CASCOON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Cascoon, 56, 32),
        .frontPicYOffset = 16,
        .frontAnimFrames = sAnims_Cascoon,
        .frontAnimId = ANIM_V_SLIDE,
        BACK_PIC(Cascoon, 56, 24),
        .backPicYOffset = 20,
        .backAnimId = BACK_ANIM_H_SHAKE,
        PALETTES(Cascoon),
        ICON(Cascoon, 2),
    ...
    [SPECIES_SEEDOT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Seedot, 32, 48),
        .frontPicYOffset = 16,
        .frontAnimFrames = sAnims_Seedot,
        .frontAnimId = ANIM_BOUNCE_ROTATE_TO_SIDES,
        BACK_PIC(Seedot, 64, 48),
        .backPicYOffset = 9,
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Taillow, 48, 32),
        .frontPicYOffset = 16,
        .frontAnimFrames = sAnims_Taillow,
        .frontAnimId = ANIM_V_JUMPS_BIG,
        BACK_PIC(Taillow, 48, 32),
        .backPicYOffset = 17,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(Taillow),
        ICON(Taillow, 2),
...
#define GARDEVOIR_MISC_INFO                                 \
    ...
    [SPECIES_GARDEVOIR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "protect its Trainer."),
        FRONT_PIC(Gardevoir, 56, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_Gardevoir,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Gardevoir, 56, 56),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        PALETTES(Gardevoir),
        ICON(Gardevoir, 1),
...
#define GALLADE_MISC_INFO                                   \
    ...
    [SPECIES_SURSKIT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Surskit, 48, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_Surskit,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Surskit, 64, 48),
        .backPicYOffset = 11,
    ...
    [SPECIES_SHROOMISH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Shroomish, 40, 32),
        .frontPicYOffset = 16,
        .frontAnimFrames = sAnims_Shroomish,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Shroomish, 64, 40),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Shroomish),
        ICON(Shroomish, 1),
    ...
    [SPECIES_BRELOOM] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Breloom, 56, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_Breloom,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Breloom, 64, 56),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        PALETTES(Breloom),
        ICON(Breloom, 1),
    ...
    [SPECIES_VIGOROTH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Vigoroth, 56, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Vigoroth,
        .frontAnimId = ANIM_H_JUMPS,
        BACK_PIC(Vigoroth, 64, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        PALETTES(Vigoroth),
        ICON(Vigoroth, 2),
    ...
    [SPECIES_SLAKING] =
    {
        ...
        .trainerScale = 300,
        .trainerOffset = 1,
        FRONT_PIC(Slaking, 64, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Slaking,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
        BACK_PIC(Slaking, 64, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_H_SHAKE,
        PALETTES(Slaking),
        ICON(Slaking, 2),
    ...
    [SPECIES_WHISMUR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Whismur, 40, 40),
        .frontPicYOffset = 14,
        .frontAnimFrames = sAnims_Whismur,
        .frontAnimId = ANIM_H_SLIDE,
        BACK_PIC(Whismur, 64, 40),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Whismur),
        ICON(Whismur, 1),
    ...
    [SPECIES_MAKUHITA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Makuhita, 48, 40),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_Makuhita,
        .frontAnimId = ANIM_SWING_CONCAVE,
        BACK_PIC(Makuhita, 56, 48),
        .backPicYOffset = 11,
    ...
    [SPECIES_SKITTY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Skitty, 48, 48),
        .frontPicYOffset = 11,
        .frontAnimFrames = sAnims_Skitty,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Skitty, 64, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Skitty),
        ICON(Skitty, 0),
    ...
    [SPECIES_DELCATTY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Delcatty, 48, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Delcatty,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(Delcatty, 64, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(Delcatty),
        ICON(Delcatty, 2),
...
#define MAWILE_MISC_INFO                                    \
    ...
    [SPECIES_LAIRON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Lairon, 56, 40),
        .frontPicYOffset = 13,
        .frontAnimFrames = sAnims_Lairon,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Lairon, 64, 32),
        .backPicYOffset = 17,
        .backAnimId = BACK_ANIM_V_SHAKE,
        PALETTES(Lairon),
        ICON(Lairon, 2),
...
#define MEDICHAM_MISC_INFO                                          \
    ...
    [SPECIES_ELECTRIKE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Electrike, 48, 32),
        .frontPicYOffset = 18,
        .frontAnimFrames = sAnims_Electrike,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Electrike, 64, 32),
        .backPicYOffset = 16,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        PALETTES(Electrike),
        ICON(Electrike, 1),
...
#define MANECTRIC_MISC_INFO                                 \
    ...
    [SPECIES_MANECTRIC] =
    {
        ...
        .trainerScale = 257,
        .trainerOffset = 0,
        FRONT_PIC(Manectric, 48, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_Manectric,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Manectric, 64, 56),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_V_SHAKE,
        PALETTES(Manectric),
        ICON(Manectric, 0),
    ...
    [SPECIES_MINUN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Minun, 48, 48),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_Minun,
        .frontAnimId = ANIM_CIRCULAR_STRETCH_TWICE,
        BACK_PIC(Minun, 56, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(Minun),
        ICON(Minun, 0),
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Volbeat, 48, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Volbeat,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Volbeat, 56, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        PALETTES(Volbeat),
        ICON(Volbeat, 0),
...
#define SHARPEDO_MISC_INFO                                      \
    ...
    [SPECIES_WAILMER] =
    {
        ...
        .trainerScale = 493,
        .trainerOffset = 0,
        FRONT_PIC(Wailmer, 56, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_Wailmer,
        .frontAnimId = ANIM_CIRCULAR_STRETCH_TWICE,
        BACK_PIC(Wailmer, 64, 24),
        .backPicYOffset = 21,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
        PALETTES(Wailmer),
        ICON(Wailmer, 2),
...
#define CAMERUPT_MISC_INFO                                  \
    ...
    [SPECIES_GRUMPIG] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Grumpig, 56, 56),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_Grumpig,
        .frontAnimId = ANIM_H_JUMPS_V_STRETCH,
        .frontAnimDelay = 15,
        BACK_PIC(Grumpig, 64, 56),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        PALETTES(Grumpig),
        ICON(Grumpig, 2),
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Trapinch, 40, 32),
        .frontPicYOffset = 16,
        .frontAnimFrames = sAnims_Trapinch,
        .frontAnimId = ANIM_V_SHAKE,
        BACK_PIC(Trapinch, 56, 40),
        .backPicYOffset = 14,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Trapinch),
        ICON(Trapinch, 0),
...
#define ALTARIA_MISC_INFO                                   \
    ...
    [SPECIES_ZANGOOSE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Zangoose, 64, 56),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_Zangoose,
        .frontAnimId = ANIM_GROW_VIBRATE,
        BACK_PIC(Zangoose, 64, 64),
        .backPicYOffset = 1,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        PALETTES(Zangoose),
        ICON(Zangoose, 0),
    ...
    [SPECIES_BARBOACH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Barboach, 32, 48),
        .frontPicYOffset = 11,
        .frontAnimFrames = sAnims_Barboach,
        .frontAnimId = ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW,
        //.enemyMonElevation = 7,
        BACK_PIC(Barboach, 48, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_V_STRETCH,
        PALETTES(Barboach),
        ICON(Barboach, 0),
    ...
    [SPECIES_CORPHISH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Corphish, 48, 48),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_Corphish,
        .frontAnimId = ANIM_V_SHAKE,
        BACK_PIC(Corphish, 56, 56),
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        PALETTES(Corphish),
        ICON(Corphish, 0),
    ...
    [SPECIES_ANORITH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Anorith, 48, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Anorith,
        .frontAnimId = ANIM_TWIST,
        BACK_PIC(Anorith, 64, 24),
        .backPicYOffset = 23,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        PALETTES(Anorith),
        ICON(Anorith, 0),
...
#define BANETTE_MISC_INFO                                           \
    ...
    [SPECIES_BANETTE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Banette, 40, 40),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_Banette,
        .frontAnimId = ANIM_SWING_CONVEX,
        .enemyMonElevation = 8,
        BACK_PIC(Banette, 48, 40),
        .backPicYOffset = 12,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        PALETTES(Banette),
        ICON(Banette, 0),
    ...
    [SPECIES_DUSKULL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Duskull, 48, 48),
        .frontPicYOffset = 10,
        .frontAnimFrames = sAnims_Duskull,
        .frontAnimId = ANIM_ZIGZAG_FAST,
        .enemyMonElevation = 9,
        BACK_PIC(Duskull, 48, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        PALETTES(Duskull),
        ICON(Duskull, 0),
    ...
    [SPECIES_DUSCLOPS] =
    {
        ...
        .trainerScale = 299,
        .trainerOffset = 1,
        FRONT_PIC(Dusclops, 56, 56),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_Dusclops,
        .frontAnimId = ANIM_H_VIBRATE,
        .frontAnimDelay = 30,
        BACK_PIC(Dusclops, 64, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        PALETTES(Dusclops),
        ICON(Dusclops, 0),
    ...
    [SPECIES_CHIMECHO] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Chimecho, 24, 56),
        .frontPicYOffset = 6,
        .frontAnimFrames = sAnims_Chimecho,
        .frontAnimId = ANIM_H_SLIDE_WOBBLE,
        .enemyMonElevation = 12,
        BACK_PIC(Chimecho, 32, 56),
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        PALETTES(Chimecho),
        ICON(Chimecho, 0),
...
#define ABSOL_MISC_INFO                                     \
    ...
    [SPECIES_ABSOL] =
    {
        ...
        FRONT_PIC(Absol, 48, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Absol,
        .frontAnimId = ANIM_CIRCULAR_VIBRATE,
        .frontAnimDelay = 45,
        BACK_PIC(Absol, 56, 64),
        .backPicYOffset = 3,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        PALETTES(Absol),
        ICON(Absol, 0),
...
#define GLALIE_MISC_INFO                                    \
    ...
    [SPECIES_GLALIE] =
    {
        ...
        .trainerScale = 344,
        .trainerOffset = 0,
        FRONT_PIC(Glalie, 56, 48),
        .frontPicYOffset = 10,
        .frontAnimFrames = sAnims_Glalie,
        .frontAnimId = ANIM_ZIGZAG_FAST,
        .enemyMonElevation = 12,
        BACK_PIC(Glalie, 64, 40),
        .backPicYOffset = 12,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        PALETTES(Glalie),
        ICON(Glalie, 0),
    ...
    [SPECIES_CLAMPERL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Clamperl, 40, 40),
        .frontPicYOffset = 14,
        .frontAnimFrames = sAnims_Clamperl,
        .frontAnimId = ANIM_TWIST,
        BACK_PIC(Clamperl, 64, 40),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Clamperl),
        ICON(Clamperl, 0),
    ...
    [SPECIES_HUNTAIL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Huntail, 56, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_Huntail,
        .frontAnimId = ANIM_GROW_VIBRATE,
        BACK_PIC(Huntail, 48, 64),
        .backPicYOffset = 2,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        PALETTES(Huntail),
        ICON(Huntail, 0),
    ...
    [SPECIES_GOREBYSS] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Gorebyss, 64, 48),
        .frontPicYOffset = 11,
        .frontAnimFrames = sAnims_Gorebyss,
        .frontAnimId = ANIM_V_SLIDE_WOBBLE,
        BACK_PIC(Gorebyss, 56, 56),
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        PALETTES(Gorebyss),
        ICON(Gorebyss, 0),
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Luvdisc, 32, 48),
        .frontPicYOffset = 24,
        .frontAnimFrames = sAnims_Luvdisc,
        .frontAnimId = ANIM_H_SLIDE_WOBBLE,
        BACK_PIC(Luvdisc, 32, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_H_SPRING_REPEATED,
        PALETTES(Luvdisc),
        ICON(Luvdisc, 0),
    ...
    [SPECIES_BAGON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Bagon, 40, 48),
        .frontPicYOffset = 11,
        .frontAnimFrames = sAnims_Bagon,
        .frontAnimId = ANIM_V_SHAKE_TWICE,
        BACK_PIC(Bagon, 48, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_V_SHAKE,
        PALETTES(Bagon),
        ICON(Bagon, 0),
...
#define SALAMENCE_MISC_INFO                                 \
    ...
    [SPECIES_SALAMENCE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Salamence, 64, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_Salamence,
        .frontAnimId = ANIM_H_SHAKE,
        .frontAnimDelay = 70,
        BACK_PIC(Salamence, 56, 56),
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_H_SHAKE,
        PALETTES(Salamence),
        ICON(Salamence, 0),
    ...
    [SPECIES_BELDUM] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Beldum, 40, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_Beldum,
        .frontAnimId = ANIM_H_SHAKE,
        .enemyMonElevation = 8,
        BACK_PIC(Beldum, 48, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        PALETTES(Beldum),
        ICON(Beldum, 0),
    ...
    [SPECIES_METANG] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Metang, 64, 56),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_Metang,
        .frontAnimId = ANIM_V_SLIDE,
        BACK_PIC(Metang, 64, 32),
        .backPicYOffset = 16,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        PALETTES(Metang),
        ICON(Metang, 0),
...
#define METAGROSS_MISC_INFO                                     \
    ...
    [SPECIES_METAGROSS] =
    {
        ...
        .trainerScale = 447,
        .trainerOffset = 9,
        FRONT_PIC(Metagross, 64, 56),
        .frontPicYOffset = 6,
        .frontAnimFrames = sAnims_Metagross,
        .frontAnimId = ANIM_V_SHAKE,
        BACK_PIC(Metagross, 64, 24),
        .backPicYOffset = 20,
        .backAnimId = BACK_ANIM_V_SHAKE,
        PALETTES(Metagross),
        ICON(Metagross, 0),
    ...
    [SPECIES_REGIROCK] =
    {
        ...
        .trainerScale = 309,
        .trainerOffset = 1,
        FRONT_PIC(Regirock, 56, 64),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_Regirock,
        .frontAnimId = ANIM_CIRCULAR_STRETCH_TWICE,
        BACK_PIC(Regirock, 64, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_V_SHAKE,
        PALETTES(Regirock),
        ICON(Regirock, 2),
    ...
    [SPECIES_REGISTEEL] =
    {
        ...
        .trainerScale = 359,
        .trainerOffset = 6,
        FRONT_PIC(Registeel, 64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_Registeel,
        .frontAnimId = ANIM_GROW_VIBRATE,
        BACK_PIC(Registeel, 64, 40),
        .backPicYOffset = 14,
        .backAnimId = BACK_ANIM_V_SHAKE,
        PALETTES(Registeel),
        ICON(Registeel, 2),
...
#define LATIAS_MISC_INFO                                                \
    ...
    [SPECIES_LATIAS] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Latias, 64, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_Latias,
        .frontAnimId = ANIM_SWING_CONCAVE_FAST_SHORT,
        .enemyMonElevation = 6,
        BACK_PIC(Latias, 64, 64),
        .backPicYOffset = 2,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        PALETTES(Latias),
        ICON(Latias, 0),
