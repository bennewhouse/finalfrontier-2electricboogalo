...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Bulbasaur, 32, 40),
        .frontPicYOffset = 14,
        .frontAnimFrames = sAnims_Bulbasaur,
        .frontAnimId = ANIM_V_JUMPS_H_JUMPS,
        BACK_PIC(Bulbasaur, 48, 32),
        .backPicYOffset = 16,
    ...
    [SPECIES_IVYSAUR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Ivysaur, 40, 48),
        .frontPicYOffset = 10,
        .frontAnimFrames = sAnims_Ivysaur,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(Ivysaur, 48, 48),
        .backPicYOffset = 9,
...
#define VENUSAUR_MISC_INFO                                                  \
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Charmander, 40, 40),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_Charmander,
        .frontAnimId = ANIM_V_JUMPS_SMALL,
        BACK_PIC(Charmander, 48, 40),
        .backPicYOffset = 14,
    ...
    [SPECIES_CHARMELEON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Charmeleon, 48, 48),
        .frontPicYOffset = 9,
        .frontAnimFrames = sAnims_Charmeleon,
        .frontAnimId = ANIM_BACK_AND_LUNGE,
        BACK_PIC(Charmeleon, 48, 48),
        .backPicYOffset = 9,
...
#define CHARIZARD_MISC_INFO                                             \
    ...
    [SPECIES_SQUIRTLE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Squirtle, 48, 40),
        .frontPicYOffset = 13,
        .frontAnimFrames = sAnims_Squirtle,
        .frontAnimId = ANIM_SWING_CONCAVE,
        BACK_PIC(Squirtle, 48, 40),
        .backPicYOffset = 14,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(Squirtle),
        ICON(Squirtle, 0),
    ...
    [SPECIES_WARTORTLE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Wartortle, 48, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Wartortle,
        .frontAnimId = ANIM_SHRINK_GROW,
        BACK_PIC(Wartortle, 56, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(Wartortle),
        ICON(Wartortle, 2),
...
#define BLASTOISE_MISC_INFO                                             \
    ...
    [SPECIES_CATERPIE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Caterpie, 32, 40),
        .frontPicYOffset = 16,
        .frontAnimFrames = sAnims_Caterpie,
        .frontAnimId = ANIM_SWING_CONCAVE,
        BACK_PIC(Caterpie, 40, 40),
        .backPicYOffset = 15,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(Caterpie),
        ICON(Caterpie, 1),
    ...
    [SPECIES_METAPOD] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Metapod, 40, 32),
        .frontPicYOffset = 20,
        .frontAnimFrames = sAnims_Metapod,
        .frontAnimId = ANIM_SWING_CONCAVE,
        BACK_PIC(Metapod, 48, 40),
        .backPicYOffset = 12,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Metapod),
        ICON(Metapod, 1),
...
#define BUTTERFREE_MISC_INFO                                                        \
    ...
    [SPECIES_WEEDLE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Weedle, 40, 32),
        .frontPicYOffset = 18,
        .frontAnimFrames = sAnims_Weedle,
        .frontAnimId = ANIM_H_SLIDE_SLOW,
        .frontAnimDelay = 10,
        BACK_PIC(Weedle, 40, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(Weedle),
        ICON(Weedle, 2),
...
#define BEEDRILL_MISC_INFO                                  \
    ...
    [SPECIES_BEEDRILL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Beedrill, 64, 48),
        .frontPicYOffset = 9,
        .frontAnimFrames = sAnims_Beedrill,
        .frontAnimId = ANIM_H_VIBRATE,
        .enemyMonElevation = 8,
        BACK_PIC(Beedrill, 64, 48),
        .backPicYOffset = 9,
    ...
    [SPECIES_PIDGEY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Pidgey, 48, 40),
        .frontPicYOffset = 13,
        .frontAnimFrames = sAnims_Pidgey,
        .frontAnimId = ANIM_V_SLIDE_SLOW,
        .enemyMonElevation = 16,
        BACK_PIC(Pidgey, 48, 48),
        .backPicYOffset = 8,
    ...
    [SPECIES_PIDGEOTTO] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Pidgeotto, 48, 56),
        .frontPicYOffset = 11,
        .frontAnimFrames = sAnims_Pidgeotto,
        .frontAnimId = ANIM_V_STRETCH,
        .frontAnimDelay = 25,
        BACK_PIC(Pidgeotto, 64, 40),
        .backPicYOffset = 12,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        PALETTES(Pidgeotto),
        ICON(Pidgeotto, 0),
...
#define RATICATE_MISC_INFO                  \
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Spearow, 32, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_Spearow,
        .frontAnimId = ANIM_RISING_WOBBLE,
        BACK_PIC(Spearow, 48, 40),
        .backPicYOffset = 12,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        PALETTES(Spearow),
        ICON(Spearow, 0),
    ...
    [SPECIES_EKANS] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Ekans, 48, 40),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_Ekans,
        .frontAnimId = ANIM_H_STRETCH,
        .frontAnimDelay = 30,
        BACK_PIC(Ekans, 48, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        PALETTES(Ekans),
        ICON(Ekans, 2),
...
#define SANDSLASH_MISC_INFO                                 \
    ...
    [SPECIES_NIDORAN_F] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(NidoranF, 32, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_NidoranF,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .frontAnimDelay = 28,
        BACK_PIC(NidoranF, 40, 40),
        .backPicYOffset = 12,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(NidoranF),
        ICON(NidoranF, 0),
    ...
    [SPECIES_NIDOQUEEN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Nidoqueen, 56, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_Nidoqueen,
        .frontAnimId = ANIM_H_SHAKE,
        BACK_PIC(Nidoqueen, 56, 56),
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_V_SHAKE,
        PALETTES(Nidoqueen),
        ICON(Nidoqueen, 2),
    ...
    [SPECIES_NIDORINO] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Nidorino, 48, 48),
        .frontPicYOffset = 9,
        .frontAnimFrames = sAnims_Nidorino,
        .frontAnimId = ANIM_SHRINK_GROW,
        BACK_PIC(Nidorino, 64, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        PALETTES(Nidorino),
        ICON(Nidorino, 2),
...
#define NINETALES_MISC_INFO                                 \
    ...
    [SPECIES_VULPIX] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "as if on fire."),
        FRONT_PIC(Vulpix, 48, 40),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_Vulpix,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(Vulpix, 56, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        PALETTES(Vulpix),
        ICON(Vulpix, 5),
    ...
    [SPECIES_JIGGLYPUFF] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Jigglypuff, 32, 40),
        .frontPicYOffset = 16,
        .frontAnimFrames = sAnims_Jigglypuff,
        .frontAnimId = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
        BACK_PIC(Jigglypuff, 48, 40),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Jigglypuff),
        ICON(Jigglypuff, 0),
    ...
    [SPECIES_WIGGLYTUFF] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Wigglytuff, 48, 56),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Wigglytuff,
        .frontAnimId = ANIM_H_JUMPS,
        BACK_PIC(Wigglytuff, 48, 48),
        .backPicYOffset = 8,
    ...
    [SPECIES_CROBAT] =
    {
        ...
        .trainerScale = 281,
        .trainerOffset = 1,
        FRONT_PIC(Crobat, 64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Crobat,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .enemyMonElevation = 6,
        BACK_PIC(Crobat, 64, 56),
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        PALETTES(Crobat),
        ICON(Crobat, 2),
    ...
    [SPECIES_ODDISH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Oddish, 32, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_Oddish,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Oddish, 40, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(Oddish),
        ICON(Oddish, 4),
    ...
    [SPECIES_PARAS] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Paras, 40, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_Paras,
        .frontAnimId = ANIM_H_SLIDE_SLOW,
        .frontAnimDelay = 10,
        BACK_PIC(Paras, 48, 24),
        .backPicYOffset = 20,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(Paras),
        ICON(Paras, 0),
    ...
    [SPECIES_PARASECT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Parasect, 64, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Parasect,
        .frontAnimId = ANIM_H_SHAKE,
        .frontAnimDelay = 45,
        BACK_PIC(Parasect, 64, 56),
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_H_SHAKE,
        PALETTES(Parasect),
        ICON(Parasect, 0),
    ...
    [SPECIES_VENONAT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = -1,
        FRONT_PIC(Venonat, 48, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Venonat,
        .frontAnimId = ANIM_V_JUMPS_H_JUMPS,
        .frontAnimDelay = 20,
        BACK_PIC(Venonat, 56, 56),
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        PALETTES(Venonat),
        ICON(Venonat, 2),
    ...
    [SPECIES_VENOMOTH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 1,
        FRONT_PIC(Venomoth, 64, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_Venomoth,
        .frontAnimId = ANIM_ZIGZAG_SLOW,
        .enemyMonElevation = 8,
        BACK_PIC(Venomoth, 56, 56),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        PALETTES(Venomoth),
        ICON(Venomoth, 2),
...
#define DUGTRIO_ATTACK (P_UPDATED_STATS >= GEN_7 ? 100 : 80)
    ...
    [SPECIES_DIGLETT] =
    {
        ...
        FRONT_PIC(Diglett, 40, 32),
        .frontPicYOffset = 18,
        .frontAnimFrames = sAnims_Diglett,
        .frontAnimId = ANIM_V_SHAKE,
        .frontAnimDelay = 25,
        BACK_PIC(Diglett, 40, 32),
        .backPicYOffset = 16,
        .backAnimId = BACK_ANIM_V_SHAKE,
        PALETTES(Diglett),
        ICON(Diglett, 2),
...
#define PERSIAN_MISC_INFO                                   \
    ...
    [SPECIES_MEOWTH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Meowth, 40, 40),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_Meowth,
        .frontAnimId = ANIM_V_JUMPS_SMALL,
        .frontAnimDelay = 40,
        BACK_PIC(Meowth, 48, 40),
        .backPicYOffset = 12,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        PALETTES(Meowth),
        ICON(Meowth, 1),
    ...
    [SPECIES_GOLDUCK] =
    {
        ...
        .trainerScale = 273,
        .trainerOffset = 1,
        FRONT_PIC(Golduck, 56, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_Golduck,
        .frontAnimId = ANIM_H_SHAKE_SLOW,
        BACK_PIC(Golduck, 56, 56),
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        PALETTES(Golduck),
        ICON(Golduck, 0),
    ...
    [SPECIES_MANKEY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Mankey, 48, 40),
        .frontPicYOffset = 14,
        .frontAnimFrames = sAnims_Mankey,
        .frontAnimId = ANIM_H_JUMPS_V_STRETCH,
        .frontAnimDelay = 20,
        BACK_PIC(Mankey, 56, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        PALETTES(Mankey),
        ICON(Mankey, 1),
    ...
    [SPECIES_PRIMEAPE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Primeape, 56, 56),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_Primeape,
        .frontAnimId = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
        BACK_PIC(Primeape, 56, 56),
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        PALETTES(Primeape),
        ICON(Primeape, 2),
...
#define ARCANINE_MISC_INFO                                  \
    ...
    [SPECIES_POLIWAG] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Poliwag, 56, 32),
        .frontPicYOffset = 19,
        .frontAnimFrames = sAnims_Poliwag,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Poliwag, 56, 32),
        .backPicYOffset = 16,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(Poliwag),
        ICON(Poliwag, 0),
    ...
    [SPECIES_POLIWHIRL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Poliwhirl, 56, 48),
        .frontPicYOffset = 10,
        .frontAnimFrames = sAnims_Poliwhirl,
        .frontAnimId = ANIM_H_JUMPS_V_STRETCH,
        .frontAnimDelay = 5,
        BACK_PIC(Poliwhirl, 48, 40),
        .backPicYOffset = 12,
        .backAnimId = BACK_ANIM_V_SHAKE,
        PALETTES(Poliwhirl),
        ICON(Poliwhirl, 0),
    ...
    [SPECIES_POLIWRATH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Poliwrath, 56, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Poliwrath,
        .frontAnimId = ANIM_V_SHAKE_TWICE,
        BACK_PIC(Poliwrath, 64, 48),
        .backPicYOffset = 11,
...
#define ALAKAZAM_MISC_INFO                                          \
    ...
    [SPECIES_MACHOP] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Machop, 40, 48),
        .frontPicYOffset = 11,
        .frontAnimFrames = sAnims_Machop,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Machop, 48, 40),
        .backPicYOffset = 12,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        PALETTES(Machop),
        ICON(Machop, 0),
    ...
    [SPECIES_MACHOKE] =
    {
        ...
        .trainerScale = 257,
        .trainerOffset = 0,
        FRONT_PIC(Machoke, 48, 56),
        .frontPicYOffset = 6,
        .frontAnimFrames = sAnims_Machoke,
        .frontAnimId = ANIM_V_SHAKE,
        BACK_PIC(Machoke, 56, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_V_SHAKE,
        PALETTES(Machoke),
        ICON(Machoke, 2),
...
#define MACHAMP_MISC_INFO                                                   \
    ...
    [SPECIES_BELLSPROUT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Bellsprout, 48, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_Bellsprout,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(Bellsprout, 48, 48),
        .backPicYOffset = 10,
    ...
    [SPECIES_WEEPINBELL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Weepinbell, 48, 48),
        .frontPicYOffset = 11,
        .frontAnimFrames = sAnims_Weepinbell,
        .frontAnimId = ANIM_SWING_CONVEX,
        .frontAnimDelay = 3,
        BACK_PIC(Weepinbell, 48, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_V_STRETCH,
        PALETTES(Weepinbell),
        ICON(Weepinbell, 1),
    ...
    [SPECIES_TENTACOOL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Tentacool, 32, 48),
        .frontPicYOffset = 9,
        .frontAnimFrames = sAnims_Tentacool,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Tentacool, 40, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(Tentacool),
        ICON(Tentacool, 0),
...
#define GOLEM_MISC_INFO                                 \
    ...
    [SPECIES_GEODUDE] =
    {
        ...
        FRONT_PIC(Geodude, 40, 32),
        .frontPicYOffset = 18,
        .frontAnimFrames = sAnims_Geodude,
        .frontAnimId = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
        .enemyMonElevation = 16,
        BACK_PIC(Geodude, 48, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        PALETTES(Geodude),
        ICON(Geodude, 1),
    ...
    [SPECIES_GRAVELER] =
    {
        ...
        FRONT_PIC(Graveler, 64, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_Graveler,
        .frontAnimId = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
        BACK_PIC(Graveler, 56, 40),
        .backPicYOffset = 12,
        .backAnimId = BACK_ANIM_H_SHAKE,
        PALETTES(Graveler),
        ICON(Graveler, 1),
    ...
    [SPECIES_GOLEM] =
    {
        ...
        .trainerScale = 296,
        .trainerOffset = 2,
        FRONT_PIC(Golem, 56, 56),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_Golem,
        .frontAnimId = ANIM_ROTATE_UP_SLAM_DOWN,
        BACK_PIC(Golem, 64, 32),
        .backPicYOffset = 16,
        .backAnimId = BACK_ANIM_H_SHAKE,
        PALETTES(Golem),
        ICON(Golem, 2),
...
#define RAPIDASH_MISC_INFO                                  \
    ...
    [SPECIES_PONYTA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Ponyta, 48, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Ponyta,
        .frontAnimId = ANIM_GLOW_ORANGE,
        .frontAnimDelay = 10,
        BACK_PIC(Ponyta, 48, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        PALETTES(Ponyta),
        ICON(Ponyta, 3),
...
#define SLOWKING_MISC_INFO                                      \
    ...
    [SPECIES_SLOWKING] =
    {
        ...
        .trainerScale = 309,
        .trainerOffset = 5,
        FRONT_PIC(Slowking, 40, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_Slowking,
        .frontAnimId = ANIM_SHRINK_GROW,
        BACK_PIC(Slowking, 48, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Slowking),
        ICON(Slowking, 0),
    ...
    [SPECIES_MAGNETON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Magneton, 56, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Magneton,
        .frontAnimId = ANIM_FLASH_YELLOW,
        .enemyMonElevation = 8,
        BACK_PIC(Magneton, 48, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        PALETTES(Magneton),
        ICON(Magneton, 0),
...
#define FARFETCHD_MISC_INFO                                 \
    ...
    [SPECIES_FARFETCHD] =
    {
        ...
        .trainerScale = 293,
        .trainerOffset = 2,
        FRONT_PIC(Farfetchd, 48, 48),
        .frontPicYOffset = 9,
        .frontAnimFrames = sAnims_Farfetchd,
        .frontAnimId = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
        BACK_PIC(Farfetchd, 48, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(Farfetchd),
        ICON(Farfetchd, 1),
    ...
    [SPECIES_DEWGONG] =
    {
        ...
        .trainerScale = 275,
        .trainerOffset = 0,
        FRONT_PIC(Dewgong, 64, 56),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_Dewgong,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
        BACK_PIC(Dewgong, 56, 56),
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(Dewgong),
        ICON(Dewgong, 2),
...
#define KANTONIAN_GRIMER_FAMILY_INFO                                                \
    ...
    [SPECIES_GRIMER] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Grimer, 48, 40),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_Grimer,
        .frontAnimId = ANIM_H_SLIDE_SLOW,
        BACK_PIC(Grimer, 56, 40),
        .backPicYOffset = 12,
        .backAnimId = BACK_ANIM_V_STRETCH,
        PALETTES(Grimer),
        ICON(Grimer, 2),
...
#define ALOLAN_GRIMER_FAMILY_INFO                                                           \
    ...
    [SPECIES_GASTLY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Gastly, 56, 56),
        .frontPicYOffset = 6,
        .frontAnimFrames = sAnims_Gastly,
        .frontAnimId = ANIM_GLOW_BLACK,
        .enemyMonElevation = 4,
        BACK_PIC(Gastly, 64, 40),
        .backPicYOffset = 14,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        PALETTES(Gastly),
        ICON(Gastly, 2),
    ...
    [SPECIES_HAUNTER] =
    {
        ...
        .trainerScale = 293,
        .trainerOffset = 2,
        FRONT_PIC(Haunter, 56, 56),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_Haunter,
        .frontAnimId = ANIM_FLICKER_INCREASING,
        .frontAnimDelay = 23,
        .enemyMonElevation = 4,
        BACK_PIC(Haunter, 56, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        PALETTES(Haunter),
        ICON(Haunter, 2),
...
#define STEELIX_MISC_INFO                                       \
    ...
    [SPECIES_DROWZEE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Drowzee, 56, 56),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_Drowzee,
        .frontAnimId = ANIM_CIRCLE_C_CLOCKWISE_SLOW,
        .frontAnimDelay = 48,
        BACK_PIC(Drowzee, 48, 40),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Drowzee),
        ICON(Drowzee, 2),
    ...
    [SPECIES_KRABBY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Krabby, 48, 40),
        .frontPicYOffset = 13,
        .frontAnimFrames = sAnims_Krabby,
        .frontAnimId = ANIM_H_SLIDE,
        BACK_PIC(Krabby, 48, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        PALETTES(Krabby),
        ICON(Krabby, 0),
...
#define KINGLER_MISC_INFO                                                               \
    ...
    [SPECIES_KINGLER] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Kingler, 64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_Kingler,
        .frontAnimId = ANIM_ZIGZAG_SLOW,
        .frontAnimDelay = 4,
        BACK_PIC(Kingler, 56, 56),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_V_SHAKE,
        PALETTES(Kingler),
        ICON(Kingler, 0),
...
#define ELECTRODE_MISC_INFO                                     \
    ...
    [SPECIES_VOLTORB] =
    {
        ...
        FRONT_PIC(Voltorb, 32, 32),
        .frontPicYOffset = 19,
        .frontAnimFrames = sAnims_Voltorb,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .enemyMonElevation = 10,
        BACK_PIC(Voltorb, 40, 40),
        .backPicYOffset = 14,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        PALETTES(Voltorb),
        ICON(Voltorb, 0),
    ...
    [SPECIES_ELECTRODE] =
    {
        ...
        FRONT_PIC(Electrode, 40, 40),
        .frontPicYOffset = 14,
        .frontAnimFrames = sAnims_Electrode,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .enemyMonElevation = 12,
        BACK_PIC(Electrode, 48, 40),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        PALETTES(Electrode),
        ICON(Electrode, 0),
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Exeggcute, 64, 56),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_Exeggcute,
        .frontAnimId = ANIM_H_SLIDE_SLOW,
        BACK_PIC(Exeggcute, 48, 40),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(Exeggcute),
        ICON(Exeggcute, 0),
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Cubone, 40, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_Cubone,
        .frontAnimId = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
        .frontAnimDelay = 30,
        BACK_PIC(Cubone, 48, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        PALETTES(Cubone),
        ICON(Cubone, 2),
...
#define MAROWAK_MISC_INFO                                       \
    ...
    [SPECIES_MAROWAK] =
    {
        ...
        FRONT_PIC(Marowak, 56, 48),
        .frontPicYOffset = 11,
        .frontAnimFrames = sAnims_Marowak,
        .frontAnimId = ANIM_BOUNCE_ROTATE_TO_SIDES,
        BACK_PIC(Marowak, 48, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        PALETTES(Marowak),
        ICON(Marowak, 2),
    ...
    [SPECIES_HITMONLEE] =
    {
        ...
        .trainerScale = 259,
        .trainerOffset = 1,
        FRONT_PIC(Hitmonlee, 64, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_Hitmonlee,
        .frontAnimId = ANIM_H_STRETCH,
        BACK_PIC(Hitmonlee, 48, 40),
        .backPicYOffset = 12,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(Hitmonlee),
        ICON(Hitmonlee, 2),
    ...
    [SPECIES_HITMONCHAN] =
    {
        ...
        .trainerScale = 277,
        .trainerOffset = 2,
        FRONT_PIC(Hitmonchan, 48, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_Hitmonchan,
        .frontAnimId = ANIM_GROW_VIBRATE,
        BACK_PIC(Hitmonchan, 48, 40),
        .backPicYOffset = 12,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        PALETTES(Hitmonchan),
        ICON(Hitmonchan, 2),
    ...
    [SPECIES_LICKITUNG] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Lickitung, 64, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Lickitung,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
        BACK_PIC(Lickitung, 48, 40),
        .backPicYOffset = 14,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(Lickitung),
        ICON(Lickitung, 0),
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Koffing, 48, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Koffing,
        .frontAnimId = ANIM_SHRINK_GROW,
        .enemyMonElevation = 8,
        BACK_PIC(Koffing, 48, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_GROW,
        PALETTES(Koffing),
        ICON(Koffing, 2),
...
#define KANGASKHAN_MISC_INFO                                    \
    ...
    [SPECIES_SEADRA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Seadra, 48, 56),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_Seadra,
        .frontAnimId = ANIM_V_SLIDE,
        BACK_PIC(Seadra, 48, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        PALETTES(Seadra),
        ICON(Seadra, 0),
...
#define MR_MIME_MISC_INFO                                           \
    ...
    [SPECIES_MR_MIME] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(MrMime, 48, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_MrMime,
        .frontAnimId = ANIM_H_SLIDE_SLOW,
        BACK_PIC(MrMime, 64, 40),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        PALETTES(MrMime),
        ICON(MrMime, 0),
...
#define SCIZOR_MISC_INFO                                \
    ...
    [SPECIES_ELEKID] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Elekid, 56, 48),
        .frontPicYOffset = 10,
        .frontAnimFrames = sAnims_Elekid,
        .frontAnimId = ANIM_FLASH_YELLOW,
        BACK_PIC(Elekid, 48, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_H_SHAKE,
        PALETTES(Elekid),
        ICON(Elekid, 1),
    ...
    [SPECIES_ELECTABUZZ] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Electabuzz, 56, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_Electabuzz,
        .frontAnimId = ANIM_FLASH_YELLOW,
        BACK_PIC(Electabuzz, 48, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        PALETTES(Electabuzz),
        ICON(Electabuzz, 1),
    ...
    [SPECIES_MAGBY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Magby, 32, 40),
        .frontPicYOffset = 13,
        .frontAnimFrames = sAnims_Magby,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Magby, 48, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        PALETTES(Magby),
        ICON(Magby, 0),
    ...
    [SPECIES_MAGMAR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Magmar, 56, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_Magmar,
        .frontAnimId = ANIM_H_SHAKE,
        BACK_PIC(Magmar, 48, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        PALETTES(Magmar),
        ICON(Magmar, 0),
...
#define PINSIR_MISC_INFO                                \
    ...
    [SPECIES_PINSIR] =
    {
        ...
        .trainerScale = 257,
        .trainerOffset = 0,
        FRONT_PIC(Pinsir, 56, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_Pinsir,
        .frontAnimId = ANIM_GROW_VIBRATE,
        BACK_PIC(Pinsir, 48, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        PALETTES(Pinsir),
        ICON(Pinsir, 2),
...
#define TAUROS_MISC_INFO                                    \
    ...
    [SPECIES_TAUROS] =
    {
        ...
        FRONT_PIC(Tauros, 56, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Tauros,
        .frontAnimId = ANIM_V_SHAKE_TWICE,
        .frontAnimDelay = 10,
        BACK_PIC(Tauros, 64, 40),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        PALETTES(Tauros),
        ICON(Tauros, 2),
...
#define LAPRAS_MISC_INFO                                                                \
    ...
    [SPECIES_LAPRAS] =
    {
        ...
        .trainerScale = 423,
        .trainerOffset = 8,
        FRONT_PIC(Lapras, 64, 40),
        .frontPicYOffset = 13,
        .frontAnimFrames = sAnims_Lapras,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(Lapras, 56, 56),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
        PALETTES(Lapras),
        ICON(Lapras, 2),
    ...
    [SPECIES_DITTO] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Ditto, 40, 32),
        .frontPicYOffset = 17,
        .frontAnimFrames = sAnims_Ditto,
        .frontAnimId = ANIM_CIRCULAR_STRETCH_TWICE,
        BACK_PIC(Ditto, 40, 32),
        .backPicYOffset = 17,
...
#define EEVEE_MISC_INFO                                                                 \
    ...
    [SPECIES_VAPOREON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Vaporeon, 48, 56),
        .frontPicYOffset = 6,
        .frontAnimFrames = sAnims_Vaporeon,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(Vaporeon, 48, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
        PALETTES(Vaporeon),
        ICON(Vaporeon, 0),
    ...
    [SPECIES_JOLTEON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Jolteon, 56, 48),
        .frontPicYOffset = 9,
        .frontAnimFrames = sAnims_Jolteon,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Jolteon, 64, 56),
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        PALETTES(Jolteon),
        ICON(Jolteon, 2),
    ...
    [SPECIES_FLAREON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Flareon, 48, 48),
        .frontPicYOffset = 10,
        .frontAnimFrames = sAnims_Flareon,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(Flareon, 48, 56),
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        PALETTES(Flareon),
        ICON(Flareon, 3),
    ...
    [SPECIES_ESPEON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Espeon, 48, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Espeon,
        .frontAnimId = ANIM_GROW_VIBRATE,
        BACK_PIC(Espeon, 56, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        PALETTES(Espeon),
        ICON(Espeon, 2),
    ...
    [SPECIES_UMBREON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Umbreon, 48, 56),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Umbreon,
        .frontAnimId = ANIM_V_SHAKE,
        BACK_PIC(Umbreon, 64, 56),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        PALETTES(Umbreon),
        ICON(Umbreon, 0),
    ...
    [SPECIES_OMANYTE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Omanyte, 32, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_Omanyte,
        .frontAnimId = ANIM_V_SLIDE_WOBBLE_SMALL,
        BACK_PIC(Omanyte, 48, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Omanyte),
        ICON(Omanyte, 0),
    ...
    [SPECIES_OMASTAR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Omastar, 48, 56),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_Omastar,
        .frontAnimId = ANIM_GROW_VIBRATE,
        BACK_PIC(Omastar, 48, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Omastar),
        ICON(Omastar, 0),
...
#define SNORLAX_MISC_INFO                                                       \
    ...
    [SPECIES_SNORLAX] =
    {
        ...
        .trainerScale = 423,
        .trainerOffset = 11,
        FRONT_PIC(Snorlax, 64, 56),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_Snorlax,
        .frontAnimId = ANIM_SWING_CONCAVE,
        BACK_PIC(Snorlax, 64, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Snorlax),
        ICON(Snorlax, 3),
...
#define MOLTRES_MISC_INFO                                               \
    ...
    [SPECIES_DRATINI] =
    {
        ...
        .trainerScale = 386,
        .trainerOffset = 6,
        FRONT_PIC(Dratini, 56, 40),
        .frontPicYOffset = 14,
        .frontAnimFrames = sAnims_Dratini,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Dratini, 48, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(Dratini),
        ICON(Dratini, 0),
    ...
    [SPECIES_DRAGONAIR] =
    {
        ...
        .trainerScale = 411,
        .trainerOffset = 5,
        FRONT_PIC(Dragonair, 64, 56),
        .frontPicYOffset = 6,
        .frontAnimFrames = sAnims_Dragonair,
        .frontAnimId = ANIM_V_SHAKE,
        BACK_PIC(Dragonair, 56, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        PALETTES(Dragonair),
        ICON(Dragonair, 0),
