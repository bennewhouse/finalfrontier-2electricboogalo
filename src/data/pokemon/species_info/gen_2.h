...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Chikorita, 56, 40),
        .frontPicYOffset = 13,
        .frontAnimFrames = sAnims_Chikorita,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Chikorita, 40, 48),
        .backPicYOffset = 10,
    ...
    [SPECIES_BAYLEEF] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Bayleef, 56, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_Bayleef,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Bayleef, 48, 48),
        .backPicYOffset = 8,
    ...
    [SPECIES_CYNDAQUIL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Cyndaquil, 40, 40),
        .frontPicYOffset = 14,
        .frontAnimFrames = sAnims_Cyndaquil,
        .frontAnimId = ANIM_V_JUMPS_SMALL,
        BACK_PIC(Cyndaquil, 56, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(Cyndaquil),
        ICON(Cyndaquil, 3),
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Quilava, 56, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Quilava,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(Quilava, 64, 56),
        .backPicYOffset = 4,
...
#define TYPHLOSION_MISC_INFO                                            \
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Sentret, 32, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_Sentret,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Sentret, 48, 56),
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(Sentret),
        ICON(Sentret, 2),
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Spinarak, 40, 32),
        .frontPicYOffset = 19,
        .frontAnimFrames = sAnims_Spinarak,
        .frontAnimId = ANIM_CIRCLE_C_CLOCKWISE_SLOW,
        BACK_PIC(Spinarak, 56, 24),
        .backPicYOffset = 21,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        PALETTES(Spinarak),
        ICON(Spinarak, 1),
    ...
    [SPECIES_LANTURN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Lanturn, 64, 56),
        .frontPicYOffset = 11,
        .frontAnimFrames = sAnims_Lanturn,
        .frontAnimId = ANIM_V_SLIDE_WOBBLE_SMALL,
        BACK_PIC(Lanturn, 64, 48),
        .backPicYOffset = 8,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Mareep, 40, 40),
        .frontPicYOffset = 16,
        .frontAnimFrames = sAnims_Mareep,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .frontAnimDelay = 50,
        BACK_PIC(Mareep, 48, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(Mareep),
        ICON(Mareep, 0),
    ...
    [SPECIES_FLAAFFY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Flaaffy, 40, 48),
        .frontPicYOffset = 10,
        .frontAnimFrames = sAnims_Flaaffy,
        .frontAnimId = ANIM_V_JUMPS_BIG,
        BACK_PIC(Flaaffy, 48, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Flaaffy),
        ICON(Flaaffy, 0),
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        FRONT_PIC(Ampharos, 56, 56),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_Ampharos,
        .frontAnimId = ANIM_FLASH_YELLOW,
        .frontAnimDelay = 10,
        BACK_PIC(Ampharos, 64, 64),
        .backPicYOffset = 1,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        PALETTES(Ampharos),
        ICON(Ampharos, 0),
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Azurill, 40, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_Azurill,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Azurill, 64, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        PALETTES(Azurill),
        ICON(Azurill, 0),
    ...
    [SPECIES_MARILL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Marill, 48, 40),
        .frontPicYOffset = 14,
        .frontAnimFrames = sAnims_Marill,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Marill, 56, 40),
        .backPicYOffset = 12,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(Marill),
        ICON(Marill, 0),
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Hoppip, 48, 48),
        .frontPicYOffset = 10,
        .frontAnimFrames = sAnims_Hoppip,
        .frontAnimId = ANIM_V_SLIDE_WOBBLE,
        .enemyMonElevation = 11,
        BACK_PIC(Hoppip, 48, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        PALETTES(Hoppip),
        ICON(Hoppip, 1),
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Jumpluff, 56, 56),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_Jumpluff,
        .frontAnimId = ANIM_V_SLIDE_WOBBLE_SMALL,
        .enemyMonElevation = 8,
        BACK_PIC(Jumpluff, 64, 56),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        PALETTES(Jumpluff),
        ICON(Jumpluff, 2),
    ...
    [SPECIES_SUNKERN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Sunkern, 32, 32),
        .frontPicYOffset = 16,
        .frontAnimFrames = sAnims_Sunkern,
        .frontAnimId = ANIM_V_JUMPS_SMALL,
        BACK_PIC(Sunkern, 40, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Sunkern),
        ICON(Sunkern, 1),
    ...
    [SPECIES_YANMA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Yanma, 64, 48),
        .frontPicYOffset = 10,
        .frontAnimFrames = sAnims_Yanma,
        .frontAnimId = ANIM_FIGURE_8,
        .enemyMonElevation = 8,
        BACK_PIC(Yanma, 56, 56),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        PALETTES(Yanma),
        ICON(Yanma, 1),
...
#define WOOPER_MISC_INFO                                                        \
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Misdreavus, 40, 40),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_Misdreavus,
        .frontAnimId = ANIM_V_SLIDE_WOBBLE,
        .enemyMonElevation = 8,
        BACK_PIC(Misdreavus, 48, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        PALETTES(Misdreavus),
        ICON(Misdreavus, 0),
...
#define UNOWN_MISC_INFO(letter)                                         \
    ...
    [SPECIES_WYNAUT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Wynaut, 40, 40),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_Wynaut,
        .frontAnimId = ANIM_H_JUMPS_V_STRETCH,
        .frontAnimDelay = 15,
        BACK_PIC(Wynaut, 56, 56),
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(Wynaut),
        ICON(Wynaut, 0),
    ...
    [SPECIES_PINECO] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Pineco, 40, 48),
        .frontPicYOffset = 10,
        .frontAnimFrames = sAnims_Pineco,
        .frontAnimId = ANIM_SWING_CONCAVE,
        BACK_PIC(Pineco, 48, 40),
        .backPicYOffset = 15,
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Dunsparce, 56, 32),
        .frontPicYOffset = 17,
        .frontAnimFrames = sAnims_Dunsparce,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .frontAnimDelay = 10,
        BACK_PIC(Dunsparce, 64, 40),
        .backPicYOffset = 15,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        PALETTES(Dunsparce),
        ICON(Dunsparce, 0),
...
#define DUDUNSPARCE_MISC_INFO(segments)                                             \
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Granbull, 40, 56),
        .frontPicYOffset = 6,
        .frontAnimFrames = sAnims_Granbull,
        .frontAnimId = ANIM_V_SHAKE,
        BACK_PIC(Granbull, 64, 56),
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_V_SHAKE,
        PALETTES(Granbull),
        ICON(Granbull, 2),
...
#define QWILFISH_MISC_INFO                                                              \
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Shuckle, 48, 48),
        .frontPicYOffset = 9,
        .frontAnimFrames = sAnims_Shuckle,
        .frontAnimId = ANIM_SWING_CONCAVE,
        BACK_PIC(Shuckle, 40, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Shuckle),
        ICON(Shuckle, 1),
...
#define URSALUNA_MISC_INFO                                  \
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Slugma, 32, 40),
        .frontPicYOffset = 13,
        .frontAnimFrames = sAnims_Slugma,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(Slugma, 48, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        PALETTES(Slugma),
        ICON(Slugma, 0),
    ...
    [SPECIES_MAGCARGO] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Magcargo, 40, 56),
        .frontPicYOffset = 13,
        .frontAnimFrames = sAnims_Magcargo,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(Magcargo, 56, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        PALETTES(Magcargo),
        ICON(Magcargo, 0),
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Swinub, 32, 24),
        .frontPicYOffset = 20,
        .frontAnimFrames = sAnims_Swinub,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Swinub, 48, 24),
        .backPicYOffset = 21,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        PALETTES(Swinub),
        ICON(Swinub, 2),
...
#define CORSOLA_MISC_INFO                                       \
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Delibird, 40, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Delibird,
        .frontAnimId = ANIM_V_JUMPS_SMALL,
        BACK_PIC(Delibird, 48, 56),
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        PALETTES(Delibird),
        ICON(Delibird, 1),
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .trainerScale = 342,
        .trainerOffset = 7,
        FRONT_PIC(Mantine, 64, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_Mantine,
        .frontAnimId = ANIM_SWING_CONVEX,
        .enemyMonElevation = 6,
        BACK_PIC(Mantine, 64, 56),
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(Mantine),
        ICON(Mantine, 2),
...
#define HOUNDOOM_MISC_INFO                                  \
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Stantler, 64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Stantler,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Stantler, 56, 64),
        .backPicYOffset = 3,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(Stantler),
        ICON(Stantler, 2),
    ...
    [SPECIES_RAIKOU] =
    {
        ...
        .trainerScale = 345,
        .trainerOffset = 7,
        FRONT_PIC(Raikou, 64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Raikou,
        .frontAnimId = ANIM_FLASH_YELLOW,
        BACK_PIC(Raikou, 64, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        PALETTES(Raikou),
        ICON(Raikou, 2),
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Larvitar, 32, 48),
        .frontPicYOffset = 9,
        .frontAnimFrames = sAnims_Larvitar,
        .frontAnimId = ANIM_V_JUMPS_SMALL,
        BACK_PIC(Larvitar, 48, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        PALETTES(Larvitar),
        ICON(Larvitar, 1),
