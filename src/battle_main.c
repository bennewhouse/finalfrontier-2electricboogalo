...
static const u16 sTrainerBallTable[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_MAGMA_ADMIN] = ITEM_TIMER_BALL,
    [TRAINER_CLASS_TEAM_MAGMA] = ITEM_TIMER_BALL,
    ...
    [TRAINER_CLASS_BEAUTY] = ITEM_HEAL_BALL,

    [TRAINER_CLASS_POKEMANIAC] = ITEM_LEVEL_BALL,
    
    [TRAINER_CLASS_RIVAL] = ITEM_PREMIER_BALL,

    [TRAINER_CLASS_BUG_CATCHER] = ITEM_NEST_BALL,
    [TRAINER_CLASS_BUG_MANIAC] = ITEM_NEST_BALL,

    [TRAINER_CLASS_WINSTRATE] = ITEM_MOON_BALL,

    [TRAINER_CLASS_YOUNG_COUPLE] = ITEM_LOVE_BALL,

    [TRAINER_CLASS_HIKER] = ITEM_HEAVY_BALL,
    [TRAINER_CLASS_GUITARIST] = ITEM_HEAVY_BALL,
    ...
    [TRAINER_CLASS_SAILOR] = ITEM_LURE_BALL,

    [TRAINER_CLASS_PKMN_RANGER] = ITEM_SAFARI_BALL,

    [TRAINER_CLASS_OLD_COUPLE] = ITEM_MOON_BALL,
    [TRAINER_CLASS_EXPERT] = ITEM_MOON_BALL,
    ...
    [TRAINER_CLASS_BLACK_BELT] = ITEM_SPORT_BALL,
    [TRAINER_CLASS_BATTLE_GIRL] =  ITEM_SPORT_BALL,
