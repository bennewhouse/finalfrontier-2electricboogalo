...
static bool8 LightenSpritePaletteInFog(u8 paletteIndex)
{
    ...
    // if (paletteIndex >= 16 && (GetSpritePaletteTagByPaletteNum(i - 16) >> 15)) // paletteIndex was originally i, I dont understand why because it shouldnt compile, per MERP: // don't blend specialpalette tags
    //     return FALSE;
